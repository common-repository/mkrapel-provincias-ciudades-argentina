...
class MkRapel_Provincia_Ciudad_AR {
	...
	public function init_states() {
		add_filter('woocommerce_states', array($this, 'mkrapel_ar_states'));
	}
	
	/* WC States init */
	public function init_places() {
		add_filter( 'woocommerce_billing_fields', array( $this, 'mkrapel_ar_billing_fields' ), 10, 2 );
		add_filter( 'woocommerce_shipping_fields', array( $this, 'mkrapel_ar_shipping_fields' ), 10, 2 );
		add_filter( 'woocommerce_form_field_city', array( $this, 'mkrapel_ar_form_field_city' ), 10, 4 );
		add_action( 'wp_enqueue_scripts', array( $this, 'mkrapel_ar_load_scripts' ) );
	}
	...
	* @return mixed
	*/
	public function  mkrapel_ar_states($states) {
	...
	* @return mixed
	*/
	public function mkrapel_ar_billing_fields( $fields, $country ) {
	...
	* @return mixed
	*/
	public function mkrapel_ar_shipping_fields( $fields, $country ) {
	...
	* @return mixed
	*/
	public function mkrapel_ar_form_field_city($field, $key, $args, $value ) {
	...
	*/
	...
	/* Load scripts */
	public function mkrapel_ar_load_scripts() {
