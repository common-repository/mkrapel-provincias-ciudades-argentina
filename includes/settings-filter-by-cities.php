...
$settings =  array(
    ...
    'title' => array(
        ...
        'default'		=> __( 'Despacho a Domicilio AR', 'woocommerce' ),
        'desc_tip'		=> true
    ),
    'tax_status' => array(
    ...
    'cities' => array(
        ...
        'type' => 'multiselect',
        'class'       => 'wc-enhanced-select',
        'description' => __( 'Seleccione las Ciudades que hace referencia a la Provincia que ha agregado anteriormente como Zona de Envío' ),
